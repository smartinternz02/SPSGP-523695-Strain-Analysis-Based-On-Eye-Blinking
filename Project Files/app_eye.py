...
def NotifyLess():
    ...
    sp2 = gtts.gTTS("I Think You are In Sleep or Not Attentive to Work So Either WakeUp From Sleep Or Blinkup")
    sp2.save("output3.mp3")
    speech.save("output2.mp3")
    playsound("output2.mp3")
    playsound("output3.mp3")
    popupmsg("I Think You are In Sleep or Not Attentive to Work So Either WakeUp From Sleep Or Blinkup")
    benefits = [
...
#Defining All Static Variables for Capturing and Detection
...
while True:
    ...
    #Defining Constraint's For Blinking
